...
const translations = {
  ...
  es: {
    ...
    secureDesc: "Construido sobre la red Stellar para transacciones seguras y rápidas",
  ...
  hi: {
    ...
    aiDesc: "प्राकृतिक भाषा कमांड का उपयोग करके अपने वॉलेट के साथ इंटरैक्ट करें",
